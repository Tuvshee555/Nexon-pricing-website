...
export default function RegisterPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    if (!res.ok) {
      setError(data.error === "Email already registered" ? "Энэ и-мэйл бүртгэлтэй байна." : data.error || "Бүртгэл амжилтгүй боллоо.");
      setLoading(false);
      return;
    }
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-[45%] flex-col justify-between p-12 bg-gradient-to-br from-[#0F4FE8] to-[#4F46E5] text-white">
        ...
        <div>
          <h2 className="text-4xl font-black leading-tight mb-4">
            Эхний алхам —<br />бүртгүүлэх
          </h2>
          <p className="text-white/70 text-lg leading-relaxed mb-8">
            Google-ээр бүртгүүлэхэд нэг дарж хангалттай. Хэдхэн минутын дотор bot тань ажиллаж эхэлнэ.
          </p>
          <div className="space-y-3">
            {[
              "Бүртгэл үнэгүй эхлүүлэх",
              "Картын мэдээлэл шаардлагагүй",
              "5 минутын дотор тохируулна",
            ].map((f) => (
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-8 bg-white">
        ...
        <div className="w-full max-w-sm">
          <div className="mb-8">
            <h1 className="text-2xl font-black text-gray-900 mb-1">Бүртгүүлэх</h1>
            <p className="text-gray-500 text-sm">Эхний удаа уу? Тавтай морил</p>
          </div>
          ...
          {!showEmail ? (
            <>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-4 py-3.5 border border-gray-200 rounded-xl text-sm font-semibold text-gray-700 bg-white hover:bg-gray-50 transition-colors mb-3 shadow-sm disabled:opacity-60"
              >
                ...
                {googleLoading ? "Үүсгэж байна..." : "Google-ээр бүртгүүлэх"}
              </button>
              ...
              <div className="relative my-5">
                ...
                <div className="relative flex justify-center text-xs">
                  <span className="bg-white px-3 text-gray-400">эсвэл</span>
                </div>
              </div>
