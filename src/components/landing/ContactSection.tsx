  ...
  return (
    <section id="contact" ref={ref} className="relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div
        ...
        style={{
          background: "radial-gradient(ellipse, rgba(15,79,232,0.7) 0%, transparent 70%)",
          filter: "blur(60px)",
        }}
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            <div className="relative overflow-hidden rounded-2xl border border-border bg-surface/80 p-6 backdrop-blur-sm">
              ...
              <h3 className="text-lg font-bold text-text-primary mb-5">Холбоо барих мэдээлэл</h3>
              <div className="space-y-3">
                {contactLinks.map((link, i) => (
                  ...
                  >
                    <div className={`w-10 h-10 rounded-xl border flex items-center justify-center transition-colors ${link.bg}`}>
                      {link.icon}
                    </div>
                    <div>
