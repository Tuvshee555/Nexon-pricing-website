...
export default function DashboardSidebar({ user, role }: Props) {
  ...
  const clientLinks = [
    { href: "/dashboard", label: "Нүүр", icon: <HomeIcon /> },
    { href: "/dashboard/contacts", label: "Contacts", icon: <ContactsIcon /> },
    { href: "/dashboard/automation", label: "Automation", icon: <AutomationIcon /> },
    { href: "/dashboard/inbox", label: "Live Chat", icon: <InboxIcon /> },
    { href: "/dashboard/broadcasts", label: "Broadcasting", icon: <BroadcastIcon /> },
    { href: "/dashboard/ai", label: "AI", icon: <AIIcon /> },
    { href: "/dashboard/settings", label: "Settings", icon: <SettingsIcon /> },
    { href: "/dashboard/buy-credits", label: "Нэмэлт авах", icon: <CreditsIcon /> },
  ];
  ...
  return (
    <>
      ...
      {mobileOpen && (
        <>
          <div className="lg:hidden fixed inset-0 bg-gray-900/40 backdrop-blur-sm z-40" onClick={() => setMobileOpen(false)} />
